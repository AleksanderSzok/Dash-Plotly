            ...
            [
                dbc.Col(
                    [
                        ...
                        html.Br(),
                        html.H1(
                            children="Flats in Warsaw primary market 2020",
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Button(
                            ...
                            id="github-link",
                            href="https://github.com/AleksanderSzok/Dash-Plotly",
                            target="_blank",
                            color="primary",
                        ),
                    ],
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dcc.Dropdown(
                            id="demo-dropdown", value="Price in PLN", clearable=False
                        ),
                        html.Br(),
                        html.Br(),
                        dcc.Dropdown(
                ...
                dbc.Col([dcc.Graph(id="example-graph", figure={}, config={})], width=6),
                dbc.Col(
                    [
                        dbc.Button(
...
def graph(value, value1):
    dff = df.copy()

    if value == "No. of flats":
        dff = (
            dff.loc[:, ["Price in PLN", "Location"]]
    ...
    fig = px.choropleth_mapbox(
        ...
        color=value,
        locations="Location",
        featureidkey="properties.nazwa_dzie",
        # projection="mercator",
        mapbox_style="carto-positron",
        zoom=9.4,
        opacity=0.6,
    ...
    fig.update_layout(
        margin={"r": 0, "t": 0, "l": 0, "b": 0},
        coloraxis_colorbar=dict(bgcolor="darksalmon", tickfont=dict(color="white")),
